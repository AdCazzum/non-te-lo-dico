...
const ENUM_STATUSES = {
  ...
  loading: (
    <div className="w-7 h-7 border-4 border-t-transparent border-[#f5c842] rounded-full animate-spin" />
  ),
    ...
    (t: Toast) => (
      <div
        style={{
          ...
          gap: '12px',
          position: 'relative',
          transform: t.visible ? 'translateY(0)' : position.substring(0, 6) === "bottom" ? 'translateY(100px)' : 'translateY(-100px)',
